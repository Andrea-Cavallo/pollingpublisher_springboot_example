...
public class KafkaConsumerConfiguration {
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, Message<String>> outboxKafkaListenerContainerFactory(
	        ConsumerFactory<String, Message<String>> consumerFactory) {
	    FixedBackOff fixedBackOff = new FixedBackOff(properties.getBackoffIntervalMillis(), properties.getRetryCount());
	    ConcurrentKafkaListenerContainerFactory<String, Message<String>> factory = new ConcurrentKafkaListenerContainerFactory<>();
    ...
    @Bean
    public Deserializer<MyMessage> messageDeserializer() {
	...
	private Map<String, Object> consumerProps() {
		...
		configuration.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, MessageDeserializer.class);
